...
HD_PWD='/home/users/kfujita/resol_hdl/segment/proj/unpool_test/unpool_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unpooling.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unpooling.tcl
